...
I don't know if this time counts!

I'm using linear Keygeek x MZ Y1 switches, fixed in hotswap sockets for ease of use, with screw-in stabilisers (transparent). My keycaps are blank white - so I can doodle on them, and create my custom design, and also so I can easily replace them, or find alternative keycaps, as my keyboard layout is a little bit different from standard ones. I also didn't know whether to add the PCB (indivudal or total) and 3D model costs to the BOM.
...
I've used RMK firmware, and I wrote it using GitHub actions (I don't know how to code in Rust!). It was pretty easy, as I kept the extra functions to a minimum. I had to first map the keyboard matrix in a toml file - the row and column pins, switch positions, and the keymap I'm going to assign to them. I wrote a keymap for vial too, so I can configure the keyboard easily when I'm flashing the firmware. I then downloaded the .uf2 generated by the Actions, and I've added it to this repo - the file I'm going to flash to the Pico.
...
<img width="1076" height="416" alt="Switches" src="https://github.com/user-attachments/assets/c79a7895-b321-4e7d-879f-9ef8f757bc20" />
...
<img width="1017" height="386" alt="Keycaps" src="https://github.com/user-attachments/assets/c1517099-20e7-46ea-a8f9-8d37aa9bbc77" />
